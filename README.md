...
The `sounds/extras/` folder contains all remaining voice lines from Richard the Lionheart that aren't mapped to a CESP category. They're included so anyone can remix or extend this pack without needing the original game files.
